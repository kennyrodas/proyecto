...
var dayArrayMed = new Array('Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sa');
...
var monthArrayMed = new Array('Ene', 'Feb', 'Mar', 'Abr', 'May', 'Juni', 'Juli', 'Ago', 'Sept', 'Oct', 'Nov', 'Dic');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  html += "<button class='dpTodayButton' onClick='refreshDatePicker(\"" + dateFieldName + "\");'>Ahora</button>&nbsp; ";
